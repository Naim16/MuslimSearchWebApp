...
<head>
    ...
    <title>Welcom to MuslimSearch</title>
        ...
        <div class="login_box">
            ...
            <div id="first">
                <form action="register.php" method="POST">
                    ...
                    <br>
                    <a href="#" id="signup" class="signup">New User? Create an Account!</a>
                </form>
                <br>
            ...
            <div id="second">
                ...
                <form action="register.php" method="POST">
                    ...
                    <?php if(in_array("Your password should be the same<br>", $error_array)) echo "Your password should be the same<br>"; 
